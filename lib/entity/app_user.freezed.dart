...
class _$AppUserImpl extends _AppUser {
  ...
  @override
  String toString() {
    return 'AppUser(id: $id, firebaseUid: $firebaseUid, email: $email, name: $name, phone: $phone, avatarUrl: $avatarUrl, fcmToken: $fcmToken, emailVerifiedAt: $emailVerifiedAt, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
